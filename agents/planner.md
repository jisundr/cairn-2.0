...
## Hands back
The task folder path, to the main thread, which shows the user the plan's Summary and waits for approval before dispatching `builder` — the second of the escalated path's two approval gates.
