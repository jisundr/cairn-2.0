...
| `.harness/BUDGET.roster.md` | `/cairn-setup --track`/`--untrack`, on request | cairn's — records which extra cairn-owned artifacts to measure into `BUDGET.md`; never asserts about the project's own content |
